...
test('forked way with disjoint nodes', function (t) {
  var input = [
    { type: 'node',
      lat: 63.9,
      lon: -147.6,
  ...
  var actual = defork(input).sort(idcmp)
  var expected = [
    input[0],
    input[2],
    input[3],
...
test('forked relation with disjoint nodes', function (t) {
  var input = [
    { type: 'node',
      lat: 62.4,
      lon: -146.3,
